...
namespace ArcelikExcelApp.Views
{
    ...
    {
        private List<HistoricalWhiteGoodsProduct> _allData = new();
        private List<HistoricalWhiteGoodsProduct> _filteredData = new();
        private int _currentPage = 1;
        private int _pageSize = 50;
        private int _totalPages = 1;

        public class HistoricalDisplayItem : HistoricalWhiteGoodsProduct
        {
            public string PeriodDisplay => $"{PeriodMonth}/{PeriodYear}";
        }

        public BeyazEsyaTarihceView()
        {
            InitializeComponent();
        }
