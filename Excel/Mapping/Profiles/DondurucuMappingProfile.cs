...
{
    /// <summary>
    /// Dondurucu Excel dosyası kolon mapping profili.
    ///
    /// Excel yapısı Soğutucu (Buzdolabı) ile aynıdır:
    ///  Row 1 = Merged kategori başlıkları
    ///  Row 2 = Gerçek kolon başlıkları
    ///  Row 3 = Bölüm başlığı satırı → ProductCode boş olduğu için otomatik atlanır
    ...
    ///  11  = 2026 NİSAN 1+8
    /// </summary>
    public static class DondurucuMappingProfile
    {
        public static ColumnMappingProfile Get() => new()
        {
            FileTypeName = "Dondurucu",
            HeaderRow    = 2,       // Gerçek başlıklar 2. satırda
            DataStartRow = 3,       // Bölüm başlık satırları ProductCode boş → atlanır
