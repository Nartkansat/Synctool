...
{
    /// <summary>
    /// KEA Elektronik Excel dosyası kolon mapping profili.
    /// </summary>
    public static class KeaElektronikMappingProfile
    {
        public static ColumnMappingProfile Get() => new()
        {
            FileTypeName = "Elektronik",
            HeaderRow    = 1,
            DataStartRow = 2,
            ...
            FieldToColumnIndex = new System.Collections.Generic.Dictionary<string, int>
            {
                ...
                { nameof(KeaProduct.WholesalePrice30),  4  }   // D -> Toptan (F+30)
            }
        };
    }
}
